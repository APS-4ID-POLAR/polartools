...
:::{grid-item-card} RXES Image Processor GUI
:link: examples/process_images_gui
:link-type: doc

The bundled `process-images-gui` PyQt application for curvature/RXES/RXES-MCD.
:::
